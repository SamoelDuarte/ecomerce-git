    ...
    <form id="scriptForm" class="" action="{{ route('admin.script.update') }}" method="post">
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="card">
            <div class="card-header">
              <div class="card-title">Menu detalhes de cobrança</div>
            </div>
            <div class="card-body">
              <div class="form-group">
                ...
                <p class="text-info mb-0">Utilizado para visualização dos detalhes de cobrança no menu lateral do cliente.</p>
              </div>
            </div>
          </div>
        </div>
