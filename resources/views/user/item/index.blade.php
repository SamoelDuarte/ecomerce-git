                                ...
                                <div class="table-responsive">
                                        ...
                                        <tbody>
                                            @foreach ($items as $key => $item)
                                                <tr>
                                                    ...
                                                    <td>{{ symbolPrice($currency->symbol_position, $currency->symbol, $item->current_price) }}
                                                    </td>
                                                    ...
                                                    @if ($item->type != 'digital')
                                                        <td>
                                                            <a class="btn btn-secondary btn-sm"
                                                                ...
                                                                <span class="btn-label">{{ __('Manage') }}</span>
                                                            </a>
                                                        </td>
                                                    @else
                                                        <td>
                                                            @if ($item->has_codes)
                                                               <a class="btn btn-secondary btn-sm"
                                                                href="{{ route('user.item.codes', $item->item_id) . '?language=' . request()->input('language') }}">
                                                                <span class="btn-label">Gerenciar Código</span>
                                                            </a>
                                                            @else
                                                                <span class="text-muted">Sem códigos</span>
                                                            @endif
                                                        </td>
                                                    @endif
                                  ...
                                  data-target="#flashmodal{{ $item->item_id }}" @endif>{{ __('Flash Sale') }}</a>
                                                                ...
                                                                <a class="dropdown-item"
                                                                    {{ $total_item > $item_limit ? 'disabled' : '' }}
                                                                        ...
                                                                        <form class="modal-form"
                                                                            ...
                                                                            <div class="form-group">
                                                                                <label for="">
                                                                                    {{ __('Discount') }} (%)</label>
                                                                                <input type="number"
                                                                                    value="{{ $item->flash_amount }}"
                                                                                    name="flash_amount"
                                                                                    class="form-control "
                                                                                    placeholder="{{ __('Enter flash deal percentage') }}">
                                                                                <p
                                                                                    class="mb-0 text-danger em errflash_amount">
                                                                                </p>
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <p id=""
                                                                                    class="mb-0 text-danger em errstart_date">
                                                                                </p>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label
                                                                                ...
                                                                                <input type="text" name="start_time"
                                                                                    ...
                                                                                    placeholder="00:00">
                                                                                <p id=""
                                                                                    class="mb-0 text-danger em errstart_time">
                                                                                </p>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="end_date"
                                                                                    ...
                                                                                    placeholder="YYYY-MM-DD">
                                                                                <p id=""
                                                                                    class="mb-0 text-danger em errend_date">
                                                                                </p>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" name="end_time"
                                                                                    ...
                                                                                    placeholder="00:00">
                                                                                <p id=""
                                                                                    class="mb-0 text-danger em errend_time">
                                                                                </p>
                                                                            </div>
