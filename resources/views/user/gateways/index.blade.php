...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card">
                <form action="{{ route('user.pagsmile.update') }}" method="post">
                    @csrf
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-title">{{ __('Pagsmile') }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        @php
                            if ($pagsmile) {
                                if (!is_null($pagsmile->information)) {
                                    $pagsmileInfo = json_decode($pagsmile->information, true);
                                } else {
                                    $pagsmileInfo = [];
                                }
                            } else {
                        ...
                        <div class="form-group">
                            <label>{{ __('Pagsmile Status') }}</label>
                            <div class="selectgroup w-100">
                                <label class="selectgroup-item">
                                    <input type="radio" name="status" value="1" class="selectgroup-input"
                                        {{ $pagsmile ? ($pagsmile->status == 1 ? 'checked' : '') : '' }}>
                                    <span class="selectgroup-button">{{ __('Active') }}</span>
                                </label>
                                <label class="selectgroup-item">
                                    <input type="radio" name="status" value="0" class="selectgroup-input"
                                        {{ $pagsmile ? ($pagsmile->status == 0 ? 'checked' : '') : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="app_id"
                                value="{{ $pagsmileInfo['APP ID'] ?? '' }}">
                            @if ($errors->has('app_id'))
                                <p class="text-danger mb-0">{{ $errors->first('app_id') }}</p>
                            @endif
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="security_key"
                                value="{{ $pagsmileInfo['Security Key '] ?? '' }}">
                            @if ($errors->has('security_key'))
                                <p class="text-danger mb-0">{{ $errors->first('security_key') }}</p>
                            @endif
                        </div>
                            ...
                            <div class="selectgroup w-100">
                                <label class="selectgroup-item">
                                    <input type="radio" name="sandbox_check" value="1" class="selectgroup-input"
                                        {{ isset($pagsmileInfo['sandbox_check']) && $pagsmileInfo['sandbox_check'] == '1' ? 'checked' : '' }}>
                                    <span class="selectgroup-button">{{ __('Yes') }}</span>
                                </label>
                                <label class="selectgroup-item">
                                    <input type="radio" name="sandbox_check" value="0" class="selectgroup-input"
                                        {{ isset($pagsmileInfo['sandbox_check']) && $pagsmileInfo['sandbox_check'] == '0' ? 'checked' : '' }}>
                        ...
                        {{-- Texto Informativo --}}
                        <div class="form-group">
                            <label>{{ __('Informational Text') }}</label>
                            <input class="form-control" type="text" name="text"
                                value="{{ $pagsmileInfo['text'] ?? '' }}">
                            @if ($errors->has('text'))
                                <p class="text-danger mb-0">{{ $errors->first('text') }}</p>
                            @endif
                        </div>
