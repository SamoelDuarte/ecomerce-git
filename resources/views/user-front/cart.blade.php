                                ...
                                <div class="item-list border radius-md">
                                    ...
                                    <div class="d-flex justify-content-between gap-2 flex-wrap ps-3 pe-3 p-10 mt-2">
                                        <h4 class="d-flex gap-2">
                                            <span>{{ $keywords['Total Items'] ?? __('Total Items') }}:</span>
                                            <span>{{ $totalQty }}</span>
                                        </h4>
                                        <h4 class="d-flex gap-2">
                                            <span>{{ $keywords['Total Price'] ?? __('Total Price') }}:</span>
                                            <span>{{ symbolPrice($user_currency->symbol_position, $user_currency->symbol, $totalCart) }}</span>
                                        </h4>
                                    </div>
                                    ...
                                    <table class="shopping-table">
                                        <thead>
                                            <tr class="table-heading">
                                                <th class="prod-column ps-3">{{ $keywords['Products'] ?? __('Products') }}
                                                </th>
                                        ...
                                        <tbody>
                                            @foreach ($cart as $key => $item)
                                                @php
                                                    $id = $item['id'];
                                                    $product = App\Models\User\UserItem::with('currency')->findOrFail(
                                                        $item['id'],
                                                    );
                                                ...
                                                <tr class="item">
                                                        ...
                                                        @if (!is_null($content))
                                                            <div class="image radius-sm">
                                                                <a href="{{ route('front.user.productDetails', [getParam(), 'slug' => $content->slug]) }}"
                                                                    class="lazy-container radius-sm ratio ratio-1-1"
                                                                    target="_blank">
                                                                    <img class="lazyload"
                                                    ...
                                                    <td class="product-desc">
                                                        @if (!is_null($content))
                                                            <div class="product-desc-wrapper">
                                                                ...
                                                                <p class="mb-2">
                                                                    <strong>{{ $keywords['Item Price'] ?? __('Item Price') }}:</strong>
                                                                    {{ symbolPrice($user_currency->symbol_position, $user_currency->symbol, $item['product_price']) }}
                                                                </p>
                                                                ...
                                                                @endphp
                                                                @php
                                                                    $itemPrincipal = \App\Models\User\UserItem::find(
                                                                        $item['id'],
                                                                    );
                                                                @endphp
                                                                @if (!empty($item['variations']) && !$itemPrincipal->hasCode())
                                                                    <p class="mb-1">
                                                                    ...
                                                                    @foreach ($item['variations'] as $k => $itm)
                                                                        ...
                                                                        @endphp
                                                                            ...
                                                                            <table class="variation-table mt-0">
                                                                                <tr class="small">
                                                                                    <td class="p-0">
                                                                                        <strong>{{ $variation_name }}:
                                                                                        </strong>
                                                                                    </td>
                                                                                    <td class="p-0 cart_variants_price">
                                                                                        <span
                                                                                            class="mx-1">{{ $vOptionName }}
                                                                                            -</span>
                                                                                        (<i
                                                                ...
                                                                @if ($shop_settings->item_rating_system == 1)
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <span
                                                                            class="ratings-total">({{ reviewCount($item['id']) }})</span>
                                                                    </div>
                                                                @endif
                                                            </div>
                                                        @endif
                                                    ...
                                                    <td class="qty">
                                                        ...
                                                        <div class="quantity-input d-flex">
                                                            ...
                                                            <input id="1" class="cart_qty" type="number"
                                                    ...
                                                    <td class="price">
                                                        <h5 class="m-0">
                                                            {{ symbolPrice($user_currency->symbol_position, $user_currency->symbol, $item['total']) }}
                                                        </h5>
                                                    </td>
                                                    <td class="text-center remove">
                                                        <span
                                                            class="fas fa-times cursor-pointer item-remove btn-remove btn-icon d-inline-block"
                                                            rel="{{ $id }}"
                                        ...
                                        <div class="col-sm-12 empty-cart-cls text-center">
                                            <svg width="258" height="203" viewBox="0 0 608 553" fill="none"
                                                ...
                                                <path
                                                    ...
                                                    stroke="#DBDDEF" stroke-width="5.1542" stroke-linecap="round"
                                                ...
                                                <path
                                                    ...
                                                    fill="#4F60F9" stroke="#DBDDEF" stroke-width="5.1542"
                                                ...
                                                <path
                                                    ...
                                                    fill="white" stroke="#DBDDEF" stroke-width="5.1542"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path
                                                ...
                                                <path
                                                    d="M279.67 251.791C280.903 242.385 285.314 233.682 292.172 227.127C299.03 220.572 307.923 216.558 317.376 215.752C326.829 214.946 336.273 217.395 344.143 222.694C352.012 227.992 357.834 235.822 360.642 244.884"
                                                    stroke="white" stroke-width="5.1542" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path
                                                ...
                                                <path d="M96.1313 427.032H118.294" stroke="#BABABA" stroke-width="5.1542"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M461.354 3V25.163" stroke="#BABABA" stroke-width="5.1542"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M450.273 14.0811H472.436" stroke="#BABABA" stroke-width="5.1542"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M198.956 69.231V91.394" stroke="#BABABA" stroke-width="5.1542"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M187.823 80.312H210.037" stroke="#BABABA" stroke-width="5.1542"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path
                                                    ...
                                                    fill="white" stroke="#BABABA" stroke-width="5.1542"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path
                                            ...
                                            <h3><strong>{{ $keywords['Your Cart is Empty'] ?? __('Your Cart is Empty') }}</strong>
                                            </h3>
                                            <h4>
