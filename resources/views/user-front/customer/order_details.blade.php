                                        ...
                                        <ul class="progress-steps">
                                            ...
                                            <li class="{{ $data->order_status == 'processing' ? 'active' : '' }}">
                                                ...
                                                <div class="progress-title">
                                                    {{ $keywords['Processing'] ?? __('Processing') }} </div>
                                            </li>
                                            ...
                                            @if ($data->order_status != 'rejected')
                                                <li class="{{ $data->order_status == 'completed' ? 'active' : '' }}">
                                                    ...
                                                    <div class="progress-title">
                                                        {{ $keywords['Completed'] ?? __('Completed') }} </div>
                                                </li>
                                            @else
                                                <li class="{{ $data->order_status == 'rejected' ? 'active' : '' }}">
                                                    <div class="icon">{{ __('3') }}</div>
                                                    <div class="progress-title">
                                                        {{ $keywords['Rejected'] ?? __('Rejected') }} </div>
                                                </li>
                                            @endif
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="prinit mb-20">
                                                        <a href="{{ asset('assets/front/invoices/' . $data->invoice_number) }}"
                                                            download="{{ $data->invoice_number }}.pdf" id="print-click"
                                                        ...
                                                        <table>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        @if ($data->payment_status == 'Pending')
                                                                            <span
                                                                                class="pending">{{ $keywords[$data->payment_status] ?? __('Pending') }}
                                                                            </span>
                                                                        @elseif ($data->payment_status == 'rejected')
                                                                            <span
                                                                                class="pending">{{ $keywords[$data->payment_status] ?? __('Rejected') }}
                                                                            </span>
                                                                        @else
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <p class="mb-0">
                                                                            {{ $keywords['Shipping Method'] ?? __('Shipping Method') }}:
                                                                        </p>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <p class="mb-0">
                                                                            {{ $keywords['Cart Total'] ?? __('Cart Total') }}
                                                                            :</p>
                                                                    </td>
                                                                    <td>
                                                                        <p class="mb-0">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <p class="mb-0">
                                                                            {{ $keywords['Shipping Charge'] ?? __('Shipping Charge') }}<small
                                                                                class="text-dark font-10">(<i
                                                                                    class="fas fa-plus"></i>) </small> :
                                                                        </p>
                                                                    </td>
                                                                    <td>
                                                                        <p class="mb-0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <p class="mb-0">
                                                                            {{ $keywords[$data->order_status] ?? __($data->order_status) }}
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <p class="mb-0">
                                                                            {{ $keywords[$data->method] ?? __($data->method) }}
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                                ...
                                                                <table>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <span
                                                                                    class="mb-0">{{ $data->shipping_email }}
                                                                                </span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                        ...
                                        <table class="table table-bordered table_ordered mb-30">
                                            ...
                                            <tbody>
                                                @foreach ($data->orderitems as $key => $order)
                                                    @php
                                                        $itemcontent = App\Models\User\UserItemContent::where(
                                                            'item_id',
                                                            $order->item_id,
                                                        )
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if (!empty($order->variations))
                                                                ...
                                                                @if (!empty($variatons))
                                                                    ...
                                                                    @foreach ($variatons as $k => $itm)
                                                                        @php
                                                                            $variant_total =
                                                                                $variant_total + $itm->price;
                                                                        @endphp
                                                                        <p class="mb-0 order_variants_price">
                                                                            {{ $k }}
                                                            ...
                                                            @endif
                                                            @if ($order->item->type == 'digital' && $order->item->download_file != null)
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            @if (!empty($order->codes) && strtolower($data->payment_status) == 'pagamento aprovado')
                                                                ...
                                                                <button type="button" class="btn btn-info btn-sm mt-2"
                                                                    ...
                                                                    data-bs-target="#viewCodesModal{{ $order->id }}">
                                                                    Ver Códigos
                                                                </button>

                                                                <!-- Modal -->
                                                                <div class="modal fade"
                                                                    id="viewCodesModal{{ $order->id }}" tabindex="-1"
                                                                    aria-labelledby="viewCodesModalLabel{{ $order->id }}"
                                                                    aria-hidden="true">
                                                                    <div class="modal-dialog modal-dialog-centered">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title"
                                                                                    id="viewCodesModalLabel{{ $order->id }}">
                                                                                    Códigos Digitais</h5>
                                                                                    ...
                                                                                    <ul class="list-group">
                                                                                        @foreach ($codesList as $codeItem)
                                                                                            <li class="list-group-item">
                                                                                                <strong>{{ $codeItem['name'] }}</strong><br>
                                                                                                Código:
                                                                                                <code>{{ $codeItem['code'] }}</code><br>
                                                                                                Valor:
                                                                                                {{ userSymbolPrice($codeItem['price'], $data->currency_position, $data->currency_sign) }}
                                                                                            </li>
                                                                                        @endforeach
                                                                                    </ul>
                                                                                @else
